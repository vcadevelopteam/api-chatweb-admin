module.exports = {
    ...
    UFN_REPORTTEMPLATE_INS: {
        query: "select * from ufn_reporttemplate_ins($id, $corpid, $orgid, $description, $status, $type, $columnjson, $filterjson, $summaryjson, $communicationchannelid, $username, $operation)",
        module: "",
        protected: "SELECT"
    },
