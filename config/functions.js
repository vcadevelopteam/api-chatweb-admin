module.exports = {
    ...
    UFN_CREATEZYXMEACCOUNT_INS: {
        query: "SELECT * FROM ufn_createzyxmeaccount_ins($firstname, $lastname, $username, $password, $email, $doctype, $docnumber, $phone, $facebookid, $googleid,$join_reason, $rolecompany, $companysize, $organizationname)",
        module: "",
        protected: "INSERT"
    },
    ...
    UFN_LEAD_INS: {
        query: "select * from ufn_lead_ins($corpid, $orgid, $id, $description, $type, $status, $expected_revenue, $date_deadline, $tags, $personcommunicationchannel, $priority, $conversationid, $columnid, $username, $index, $phone, $email, $operation)",
        module: "",
        protected: "SELECT"
    },
    UFN_LEAD_PERSON_INS: {
    ...
    UFN_LEAD_INS: {
        query: "select * from ufn_lead_ins($corpid,$orgid, $leadid, $description, $type, $status, $expected_revenue, $date_deadline, $tags, $personcommunicationchannel, $priority, $conversationid, $columnid, $column_uuid, $username, $index, $operation)",
        module: "",
        protected: "INSERT"
    },
    UFN_LEADNOTES_SEL: {
