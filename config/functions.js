module.exports = {
    ...
    UFN_LEAD_INS: {
        query: "select * from ufn_lead_ins($corpid, $orgid, $id, $description, $type, $status, $expected_revenue, $date_deadline, $tags, $personcommunicationchannel, $priority, $conversationid, $columnid, $username, $index, $operation)",
        module: "",
        protected: "SELECT"
    },
    UFN_LEAD_PERSON_INS: {
    ...
    UFN_LEAD_INS: {
        query: "select * from ufn_lead_ins($corpid,$orgid, $leadid, $description, $status, $type, $expected_revenue, $date_deadline, $tags, $personcommunicationchannel, $priority, $conversationid, $columnid, $column_uuid, $username, $index, $operation)",
        module: "",
        protected: "INSERT"
    },
}