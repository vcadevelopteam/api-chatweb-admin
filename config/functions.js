module.exports = {
    ...
    UFN_PERSON_PCC_INS: {
        query: "select * from ufn_person_pcc_ins( $id, $corpid, $orgid, $groups, $status, $type, $persontype, $personstatus, $phone, $email, $birthday, $alternativephone, $alternativeemail, $documenttype, $documentnumber, $firstname, $lastname, $sex, $gender, $civilstatus, $occupation, $educationlevel, $referringpersonid, $observation, $address, $healthprofessional, $referralchannel, $district, $username, $operation, $variablecontext, $age, $salary, $termsandconditions, $clientnumber, $contact, $country, $province, $region, $addressreference, $latitude, $longitude, $postalcode, $addressnumber, $floor_number, $ubigeocode, $address_book )",
        module: ["/person"],
        protected: "SELECT"
    },
    UFN_LEAD_INS: {
