module.exports = {
    ...
    CHATWEBAPPLICATION_SEL: "select * from ufn_chatwebapplication_sel($orgid)",
    UFN_CHATWEBAPPLICATION_INS: "select * from ufn_chatwebapplication_ins($orgid, $id, $name, $operation, $description, $type, $status, $username)",
