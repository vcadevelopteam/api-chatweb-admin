module.exports = {
    ...
    messagetemplate: {
        ...
        communicationchanneldesc: {
            column: "(SELECT string_agg(CC.description, ',') FROM communicationchannel CC WHERE CC.corpid = MT.corpid AND CC.orgid = MT.orgid AND CC.status = 'ACTIVO' AND CC.communicationchannelid = ANY(string_to_array(MT.communicationchannelid, ',')::bigint[]))"
        },
        name: {
            column: "MT.name"
        },
